...
public final class CloudAppRestfulApiTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        server = new RestfulServer(19001);
    ...
    public void assertRegister() throws Exception {
        ...
        assertThat(sentRequest("http://127.0.0.1:19001/app", "POST", CloudAppJsonConstants.getAppJson("test_app")), is(204));
        verify(regCenter).persist("/config/app/test_app", CloudAppJsonConstants.getAppJson("test_app"));
        sentRequest("http://127.0.0.1:19001/app", "DELETE", "test_app");
    }
    ...
    public void assertRegisterWithExistedName() throws Exception {
        ...
        assertThat(sentRequest("http://127.0.0.1:19001/app", "POST", CloudAppJsonConstants.getAppJson("test_app")), is(500));
        sentRequest("http://127.0.0.1:19001/app", "DELETE", "test_app");
    }
    
    @Test
    public void assertRegisterWithBadRequest() throws Exception {
        assertThat(sentRequest("http://127.0.0.1:19001/app", "POST", "\"{\"appName\":\"wrong_job\"}"), is(500));
    }
    ...
    public void assertUpdate() throws Exception {
        ...
        when(regCenter.get("/config/app/test_app")).thenReturn(CloudAppJsonConstants.getAppJson("test_app"));
        assertThat(sentRequest("http://127.0.0.1:19001/app", "PUT", CloudAppJsonConstants.getAppJson("test_app")), is(204));
    ...
    public void assertDetail() throws Exception {
        when(regCenter.get("/config/app/test_app")).thenReturn(CloudAppJsonConstants.getAppJson("test_app"));
        assertThat(sentGetRequest("http://127.0.0.1:19001/app/test_app"), is(CloudAppJsonConstants.getAppJson("test_app")));
        verify(regCenter).get("/config/app/test_app");
    }
    
    @Test
    public void assertDetailWithNotExistedJob() throws Exception {
        assertThat(sentRequest("http://127.0.0.1:19001/app/notExistedJobName", "GET", ""), is(500));
    }
    ...
    public void assertFindAllJobs() throws Exception {
        ...
        when(regCenter.get("/config/app/test_app")).thenReturn(CloudAppJsonConstants.getAppJson("test_app"));
        assertThat(sentGetRequest("http://127.0.0.1:19001/app/list"), is("[" + CloudAppJsonConstants.getAppJson("test_app") + "]"));
